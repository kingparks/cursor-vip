...
⚠️ 使用本项目所产生花费及收益比与官方一样，本项目没有更便宜，只是因为分摊了，所以感觉花费更少。但是稳定性和速度都不如官方。

⚠️ 我们后期计划与 cursor 官方合作，为能够促进世界文明进步的项目提供支持。

⚠️ 遇到问题可以尝试下小额刷新 (通过快捷键 u3o、u3d、u3t、u3h 手动刷新账号)。

⚠️ 无法保证 Claude 模型的稳定使用，默认模型很稳定

⚠️ 到期后付费是增加工具使用时间，小额刷新付费验证也会增加使用时间。
